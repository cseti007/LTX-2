"""Regression tests for the CS-Fluctuation tracker.

Covers the CSFluctuationTracker numeric core: the memory-efficient cosine
identity vs a naive reference, boundary cases, the empty/perturbed behaviour on
a real PEFT model, and the Eq. 3-4 fluctuation math (ramp/convex/lr-norm).
"""
